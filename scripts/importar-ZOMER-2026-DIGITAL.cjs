/**
 * importar-ZOMER-2026-DIGITAL.cjs
 * Importa imagens de "ZOMER 2026 DIGITAL" para public/ e atualiza o banco.
 * Uso: node scripts/importar-ZOMER-2026-DIGITAL.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/ZOMER 2026 DIGITAL/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'ZOMER 2026 DIGITAL'
