/**
 * importar-Unic-2024.cjs
 * Importa imagens de "Unic 2024" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Unic-2024.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Unic 2024/imagens dos produtos/pag XX/
