/**
 * importar-SIER-2025.cjs
 * Importa imagens de "SIER 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-SIER-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/SIER 2025/imagens dos produtos/pag XX/
