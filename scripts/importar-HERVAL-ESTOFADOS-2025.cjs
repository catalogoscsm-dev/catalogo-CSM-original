/**
 * importar-HERVAL-ESTOFADOS-2025.cjs
 * Importa imagens de "HERVAL ESTOFADOS 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-HERVAL-ESTOFADOS-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/HERVAL ESTOFADOS 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'HERVAL ESTOFADOS 2025'
