/**
 * importar-Mestre-Artes-o-2025.cjs
 * Importa imagens de "Mestre Artesão 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Mestre-Artes-o-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Mestre Artesão 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Mestre Artesão 2025'
