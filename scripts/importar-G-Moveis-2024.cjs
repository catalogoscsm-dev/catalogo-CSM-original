/**
 * importar-G-Moveis-2024.cjs
 * Importa imagens de "G.Moveis 2024" para public/ e atualiza o banco.
 * Uso: node scripts/importar-G-Moveis-2024.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/G.Moveis 2024/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'G.Moveis 2024'
