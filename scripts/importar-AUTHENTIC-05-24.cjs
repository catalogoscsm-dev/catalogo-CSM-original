/**
 * importar-AUTHENTIC-05-24.cjs
 * Importa imagens de "AUTHENTIC 05.24" para public/ e atualiza o banco.
 * Uso: node scripts/importar-AUTHENTIC-05-24.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/AUTHENTIC 05.24/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'AUTHENTIC 05.24'
