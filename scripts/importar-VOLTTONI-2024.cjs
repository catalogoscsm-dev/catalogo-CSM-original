/**
 * importar-VOLTTONI-2024.cjs
 * Importa imagens de "VOLTTONI 2024" para public/ e atualiza o banco.
 * Uso: node scripts/importar-VOLTTONI-2024.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/VOLTTONI 2024/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'VOLTTONI 2024'
