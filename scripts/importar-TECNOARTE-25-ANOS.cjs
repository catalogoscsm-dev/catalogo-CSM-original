/**
 * importar-TECNOARTE-25-ANOS.cjs
 * Importa imagens de "TECNOARTE 25 ANOS" para public/ e atualiza o banco.
 * Uso: node scripts/importar-TECNOARTE-25-ANOS.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/TECNOARTE 25 ANOS/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'TECNOARTE 25 ANOS'
