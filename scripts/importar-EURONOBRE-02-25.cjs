/**
 * importar-EURONOBRE-02-25.cjs
 * Importa imagens de "EURONOBRE 02.25" para public/ e atualiza o banco.
 * Uso: node scripts/importar-EURONOBRE-02-25.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/EURONOBRE 02.25/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'EURONOBRE 02.25'
