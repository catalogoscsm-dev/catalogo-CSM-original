/**
 * importar-DAF-2025.cjs
 * Importa imagens de "DAF 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-DAF-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/DAF 2025/imagens dos produtos/pag XX/
