/**
 * importar-Zenit-Dez-2025.cjs
 * Importa imagens de "Zenit Dez 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Zenit-Dez-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Zenit Dez 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Zenit Dez 2025'
