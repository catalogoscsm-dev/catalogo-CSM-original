/**
 * importar-A-o-Mobilia-2025-7.cjs
 * Importa imagens de "Aço Mobilia 2025-7" para public/ e atualiza o banco.
 * Uso: node scripts/importar-A-o-Mobilia-2025-7.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Aço Mobilia 2025-7/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Aço Mobilia 2025-7'
