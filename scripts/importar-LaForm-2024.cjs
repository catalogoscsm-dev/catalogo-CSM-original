/**
 * importar-LaForm-2024.cjs
 * Importa imagens de "LaForm 2024" para public/ e atualiza o banco.
 * Uso: node scripts/importar-LaForm-2024.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/LaForm 2024/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'LaForm 2024'
