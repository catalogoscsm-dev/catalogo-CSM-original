/**
 * importar-SV-OZKI-2025.cjs
 * Importa imagens de "SV OZKI 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-SV-OZKI-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/SV OZKI 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'SV OZKI 2025'
