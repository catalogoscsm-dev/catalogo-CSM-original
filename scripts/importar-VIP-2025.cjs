/**
 * importar-VIP-2025.cjs
 * Importa imagens de "VIP 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-VIP-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/VIP 2025/imagens dos produtos/pag XX/
