/**
 * importar-Combinare-Domi-2025-1.cjs
 * Importa imagens de "Combinare Domi 2025.1" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Combinare-Domi-2025-1.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Combinare Domi 2025.1/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Combinare Domi 2025.1'
