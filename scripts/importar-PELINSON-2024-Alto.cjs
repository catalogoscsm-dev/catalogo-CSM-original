/**
 * importar-PELINSON-2024-Alto.cjs
 * Importa imagens de "PELINSON  2024 - Alto" para public/ e atualiza o banco.
 * Uso: node scripts/importar-PELINSON-2024-Alto.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/PELINSON  2024 - Alto/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'PELINSON  2024 - Alto'
