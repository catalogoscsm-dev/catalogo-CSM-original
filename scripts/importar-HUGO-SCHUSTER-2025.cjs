/**
 * importar-HUGO-SCHUSTER-2025.cjs
 * Importa imagens de "HUGO SCHUSTER 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-HUGO-SCHUSTER-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/HUGO SCHUSTER 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'HUGO SCHUSTER 2025'
