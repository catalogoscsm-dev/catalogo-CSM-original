/**
 * importar-FARUK-AGOSTO-2025.cjs
 * Importa imagens de "FARUK AGOSTO 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-FARUK-AGOSTO-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/FARUK AGOSTO 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'FARUK AGOSTO 2025'
