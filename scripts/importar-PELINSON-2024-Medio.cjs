/**
 * importar-PELINSON-2024-Medio.cjs
 * Importa imagens de "PELINSON 2024 - Medio" para public/ e atualiza o banco.
 * Uso: node scripts/importar-PELINSON-2024-Medio.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/PELINSON 2024 - Medio/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'PELINSON 2024 - Medio'
