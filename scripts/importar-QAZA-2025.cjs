/**
 * importar-QAZA-2025.cjs
 * Importa imagens de "QAZA 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-QAZA-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/QAZA 2025/imagens dos produtos/pag XX/
