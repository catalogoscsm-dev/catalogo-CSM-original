/**
 * importar-PELINSON-2024-Baixo.cjs
 * Importa imagens de "PELINSON 2024 - Baixo" para public/ e atualiza o banco.
 * Uso: node scripts/importar-PELINSON-2024-Baixo.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/PELINSON 2024 - Baixo/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'PELINSON 2024 - Baixo'
