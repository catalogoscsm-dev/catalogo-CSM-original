/**
 * importar-JAMES-Cat-logo.cjs
 * Importa imagens de "JAMES Catálogo" para public/ e atualiza o banco.
 * Uso: node scripts/importar-JAMES-Cat-logo.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/JAMES Catálogo/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'JAMES Catálogo'
