/**
 * importar-HERVAL-COLCH-ES-2025.cjs
 * Importa imagens de "HERVAL COLCHÕES 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-HERVAL-COLCH-ES-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/HERVAL COLCHÕES 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'HERVAL COLCHÕES 2025'
