/**
 * importar-Manuela-Decor-2025-1.cjs
 * Importa imagens de "Manuela Decor 2025-1" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Manuela-Decor-2025-1.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Manuela Decor 2025-1/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Manuela Decor 2025-1'
