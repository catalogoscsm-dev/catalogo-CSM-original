/**
 * importar-KLASSIC-2024.cjs
 * Importa imagens de "KLASSIC 2024" para public/ e atualiza o banco.
 * Uso: node scripts/importar-KLASSIC-2024.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/KLASSIC 2024/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'KLASSIC 2024'
