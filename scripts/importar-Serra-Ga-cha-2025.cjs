/**
 * importar-Serra-Ga-cha-2025.cjs
 * Importa imagens de "Serra Gaúcha 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Serra-Ga-cha-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Serra Gaúcha 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Serra Gaúcha 2025'
