/**
 * importar-Movelano-2025.cjs
 * Importa imagens de "Movelano 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Movelano-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Movelano 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Movelano 2025'
