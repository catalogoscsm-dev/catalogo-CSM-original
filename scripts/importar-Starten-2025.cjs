/**
 * importar-Starten-2025.cjs
 * Importa imagens de "Starten 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Starten-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Starten 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Starten 2025'
