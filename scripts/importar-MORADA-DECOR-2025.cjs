/**
 * importar-MORADA-DECOR-2025.cjs
 * Importa imagens de "MORADA DECOR_2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-MORADA-DECOR-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/MORADA DECOR_2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'MORADA DECOR_2025'
