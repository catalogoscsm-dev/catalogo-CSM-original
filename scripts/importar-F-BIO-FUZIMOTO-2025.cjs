/**
 * importar-F-BIO-FUZIMOTO-2025.cjs
 * Importa imagens de "FÁBIO FUZIMOTO 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-F-BIO-FUZIMOTO-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/FÁBIO FUZIMOTO 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'FÁBIO FUZIMOTO 2025'
