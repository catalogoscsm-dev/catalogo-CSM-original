/**
 * importar-Deccor-2025-lan-amentos.cjs
 * Importa imagens de "Deccor 2025 lançamentos" para public/ e atualiza o banco.
 * Uso: node scripts/importar-Deccor-2025-lan-amentos.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/Deccor 2025 lançamentos/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'Deccor 2025 lançamentos'
