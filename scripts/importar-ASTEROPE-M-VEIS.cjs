/**
 * importar-ASTEROPE-M-VEIS.cjs
 * Importa imagens de "ASTEROPE MÓVEIS" para public/ e atualiza o banco.
 * Uso: node scripts/importar-ASTEROPE-M-VEIS.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/ASTEROPE MÓVEIS/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'ASTEROPE MÓVEIS'
