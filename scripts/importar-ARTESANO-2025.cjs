/**
 * importar-ARTESANO-2025.cjs
 * Importa imagens de "ARTESANO 2025" para public/ e atualiza o banco.
 * Uso: node scripts/importar-ARTESANO-2025.cjs
 *
 * Estrutura esperada:
 *   catalogos separados/ARTESANO 2025/imagens dos produtos/pag XX/
...
const CATALOG_PASTA = 'ARTESANO 2025'
